...
(function() {
  ...
  var fortunePool = [
    ...
    '春捂秋冻，老来没病，四季衣着的智慧不可小觑。',
    '晨起一杯温水润脏腑，睡前热水泡脚暖全身。',
    '肝喜条达，常笑多乐胜过逍遥散；心主神明，淡泊宁静便是生脉饮。',
    '三分治，七分养，疾病既愈之后更需久久为功。',
    '久坐伤肉，久卧伤气，动则身健，静则神安。',
    '胃喜暖恶寒，饮食温热有节，脾胃安和百病不生。',
    '春夏养阳如播种希望，秋冬养阴如收藏果实。',
    '天人相应，日出而作日入而息，是最好的养生功法。',
    '天地之气，顺之则生，逆之则病，四季养生贵在顺势而行。',
    '寡言语以养气，节饮食以养胃，少思虑以养心。',
    '夜卧早起，顺应天时，阳气足则百邪不侵。',
    '饮食自倍，肠胃乃伤，每餐七分饱最相宜。',
    '形劳而不倦，气从以顺，各从其欲皆得所愿。',
    '法于阴阳，和于术数，食饮有节，起居有常。',
  ...
  var featuredHerbs = [
    ...
    {
      name: '金银花',
      property: '性味：甘、寒 | 归经：肺、心、胃',
      effect: '清热解毒，疏散风热。',
      desc: '金银花偏于清解热毒，气味芳香，常见于咽喉不适和风热感受相关调理，也是夏季凉茶的常用原料。',
      cssClass: 'type-flower',
      img: 'images/herbs/jinyinhua.jpg'
    },
    {
      name: '陈皮',
      property: '性味：苦、辛、温 | 归经：脾、肺',
      effect: '理气健脾，燥湿化痰。',
      desc: '陈皮以陈久者为佳，香气醇厚，擅长理气和中，是脾胃气滞、痰湿停聚的常见用药，也是日常煲汤泡茶的常用之品。',
      cssClass: 'type-peel',
      img: 'images/herbs/chenpi.jpg'
    },
    {
      name: '山药',
      property: '性味：甘、平 | 归经：脾、肺、肾',
      effect: '补脾养胃，生津益肺，补肾固精。',
      desc: '山药性味甘平，补而不燥，是药食同源的典范。适合脾胃虚弱、久咳虚喘、肾虚遗精等日常调养，蒸食、煮粥、煲汤皆宜。',
      cssClass: 'type-root'
    }
  ];
  ...
  function initFortune() {
    ...
    fortuneBtn.addEventListener('click', function() {
      ...
      function onAnimEnd() {
        fortuneBtn.removeEventListener('animationend', onAnimEnd);
      ...
      fortuneBtn.addEventListener('animationend', onAnimEnd, { once: true });
    });
  }
