...
(function() {
  ...
  function showResult() {
    ...
    if (totalScore <= 2) {
      resultType = "平和质";
      resultAdvice = "恭喜！您的体质较为平和健康。建议：保持现有的良好生活习惯，饮食均衡，适度运动，保持乐观心态。不同季节根据节气变化微调生活方式即可。";
    } else if (totalScore <= 5) {
      resultType = "气虚质 / 阳虚质倾向";
      resultAdvice = "您有轻度气虚或阳虚倾向。建议：饮食上适当增加温补食物，如红枣、山药、羊肉等。保证充足睡眠，避免过度劳累。适当进行太极拳、八段锦等温和运动，增强体质。注意保暖，尤其护好腹部和足部。";
    } else if (totalScore <= 8) {
      resultType = "阴虚质 / 湿热质倾向";
      resultAdvice = "您有阴虚或湿热倾向。建议：饮食清淡，多食滋阴润燥之品，如银耳、百合、梨。忌食辛辣油炸食物。保持充足睡眠，避免熬夜。适当饮用菊花茶、金银花茶清热。注意皮肤清洁保湿。";
    } else {
      resultType = "气郁质 / 血瘀质倾向";
      resultAdvice = "您有气郁或血瘀倾向。建议：保持心情舒畅，多进行户外活动和社交。饮食上适当食用活血化瘀食物，如山楂、玫瑰花茶。练习瑜伽、太极等舒展运动。睡前泡脚促进血液循环。如持续不适，建议咨询中医师。";
    }
